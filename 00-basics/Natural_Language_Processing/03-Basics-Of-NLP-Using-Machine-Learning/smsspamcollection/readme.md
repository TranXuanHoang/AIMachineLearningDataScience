...
- The amount of 1,002 SMS ham messages and 322 spam messages extracted from the SMS Spam Corpus v.0.1 Big created by Jos・Mar僘 Gez Hidalgo and public available at: http://www.esp.uem.es/jmgomez/smsspamcorpus/
...
The corpus has been collected by Tiago Agostinho de Almeida (http://www.dt.fee.unicamp.br/~tiago) and Jos・Mar僘 Gez Hidalgo (http://www.esp.uem.es/jmgomez).
...
1. Tiago Agostinho de Almeida and Jos・Mar僘 Gez Hidalgo hold the copyrigth (c) for the SMS Spam Collection v.1.
